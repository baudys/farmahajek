export const timeline = [
  {
    titlecs: 'Narození kuřátek v Líhni Studenec',
    titleen: 'Birth of chicks in Studenec hatchery',
    titlede: 'Geburt von Küken in der Brüterei Studenec',
  ...
  },
  {
    ...
    titleen: 'Fattening chickens on our farm',
    titlede: 'Masthühner auf unserem Bauernhof',
    textcs:
      'Kuřice dostávají vyváženou stravu ve formě krmných směsí pocházející z České republiky.',
    texten:
  ...
  },
  {
    ...
    titleen: 'The breeding is under constant veterinary supervision',
    titlede: 'Die Zucht steht unter ständiger tierärztlicher Aufsicht',
    textcs: 'Slepičkám se nemůže nic stát a vyrůstají v dobrém prostředí',
    texten:
  ...
  },
  {
    ...
    titleen: 'Raising on free litter',
    titlede: 'Aufzucht auf freier Streu',
    textcs:
      'Kuřice jsou vhodné pro domácí chov na dvorech a zahradách (jsou zvyklé na pohyb)',
    texten:
  ...
  },
  {
    titlecs: '100 % české',
    titleen: '100% Czech',
    titlede: '100% Tschechisch',
    textcs:
      'Kuřátka pochází z české líhně, vyrůstají u nás na české rodinné farmě a dostávají krmení z Česka',
    texten:
