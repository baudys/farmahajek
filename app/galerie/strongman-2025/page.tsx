...
const totalItems = strongman2025.length
        ...
        <section>
          <div className='grid grid-cols-2 gap-2 md:hidden'>
            <div className='flex flex-col gap-2'>
              {strongman2025.slice(0, itemsPer2Column).map((item) => (
                <Photo key={item} photo={item} />
              ))}
            </div>
            <div className='flex flex-col gap-2'>
              {strongman2025.slice(itemsPer2Column).map((item) => (
                <Photo key={item} photo={item} />
              ))}
            </div>
          </div>
          ...
          <div className='hidden grid-cols-3 gap-6 md:grid'>
            <div className='flex flex-col gap-6'>
              {strongman2025.slice(0, itemsPer3Column).map((item) => (
                <Photo key={item} photo={item} />
              ))}
            </div>
            <div className='flex flex-col gap-6'>
