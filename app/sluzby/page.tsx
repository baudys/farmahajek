      ...
      <Container styles='mt-10'>
        ...
        >
          ...
          {language === 'en' && (
            <>
              <p>
                The rearing is done on free litter, so the chickens are suitable
                for for home breeding in yards and gardens (they are accustomed
                to movement).
              </p>
              <p>
              ...
              <p className='font-bold'>We are breeders, we are not SELLERS.</p>
            </>
          )}
          {language === 'de' && (
            <>
          ...
          {language === 'en' && (
            <>
              ...
              <p>
                ...
                barn with laying nest technology from the Company kovobel s.r.o.
              </p>
            </>
          )}
          {language === 'de' && (
            <>
              ...
              <p>
                Wir verkaufen Eier sowohl in unserem Familienbetrieb als auch in
                anderen Geschäften
              </p>
        ...
        >
          ...
          {language === 'en' && (
            <>
              ...
              <p>
                {' '}
                john deere 7530 premium tractor + mammut 1200 l mixer (concrete
                mixing)
              </p>
            </>
          )}
        ...
        >
          ...
          {language === 'de' && (
            <>
              ...
              <p>
                Wir beschäftigen uns mit dem Anbau von Speisekartoffeln, die ab
                Hof und in Vertragsläden zu kaufen sind.
              </p>
              ...
              <p>
                - Transport von landwirtschaftlichen Gütern 20 t-Sattelauflieger
              </p>

              <h3>John Deere 5055e Traktor</h3>
              <p>
                - Mulchgerät Cormino mit horizontaler Drehachse und Hämmern mit
                2 m Reichweite
              </p>
            </>
          )}
